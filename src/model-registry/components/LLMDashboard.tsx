...
type LLMDashboardImplState = any;

// TODO: Write integration tests for this component
export class LLMDashboardImpl extends Component<
  LLMDashboardImplProps,
  LLMDashboardImplState
> {
...
const LLMDashboardWithRouter = withRouterNext(
  connect(mapStateToProps, mapDispatchToProps)(LLMDashboardImpl),
);

export const LLMDashboard = withErrorBoundary(
  ErrorUtils.mlflowServices.MODEL_REGISTRY,
  LLMDashboardWithRouter,
);
